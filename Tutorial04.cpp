 ...
 */
static int queue_picture(VideoState * videoState, AVFrame * pFrame)
{
...
int Tutorial04()
{
    ...
    videoState = (VideoState*)av_mallocz(sizeof(VideoState)); // allocate memory  and zero it out
    ...
    videoState->maxFramesToDecode = 1000; // [1]
